...
- Creates new Rojo-backed folders, scripts, local scripts, module scripts, JSON/TOML modules, models, remote events/functions, bindable events/functions, bool/int/number/object/vector/cframe/color/string values, and localization tables under filesystem-backed folder resources.
