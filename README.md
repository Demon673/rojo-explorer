...
- Creates new Rojo-backed folders, scripts, local scripts, module scripts, JSON/TOML modules, models, remote events, string values, and localization tables under filesystem-backed folder resources.
