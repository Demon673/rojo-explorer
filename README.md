...
- Creates new Rojo-backed folders, scripts, local scripts, module scripts, models, string values, and localization tables under filesystem-backed folder resources.
